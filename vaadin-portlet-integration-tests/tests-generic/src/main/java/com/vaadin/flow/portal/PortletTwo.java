...
public class PortletTwo extends Div implements WindowStatePortletComponent {
    ...
    public void renderNormal() {
        Image image = new Image(APPLICATION_IMAGE,
                "Application image");
    ...
    public void renderMinimized() {
        // NO-OP as we have nothing to show inm minimized mode.
    }
}
