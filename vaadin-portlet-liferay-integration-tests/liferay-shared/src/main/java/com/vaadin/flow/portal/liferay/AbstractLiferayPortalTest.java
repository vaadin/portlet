...
public abstract class AbstractLiferayPortalTest extends ParallelTest {
    ...
    private static final String PORTAL_ROUTE = "c/portal/login";
    ...
    public AbstractLiferayPortalTest(String warName, String portletName) {
    ...
    protected void loginToPortal() {
        if (!findElements(By.id("_com_liferay_login_web_portlet_LoginPortlet_loginForm")).isEmpty()) {
            final WebElement username = findElement(By.id("_com_liferay_login_web_portlet_LoginPortlet_login"));
            final WebElement password = findElement(By.id("_com_liferay_login_web_portlet_LoginPortlet_password"));
            final WebElement login = findElement(By.id("_com_liferay_login_web_portlet_LoginPortlet_bupk"));
